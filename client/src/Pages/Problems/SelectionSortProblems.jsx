...
export default function SelectionSortProblems() {
    const [activeButton, setActiveButton] = useState(4); // Default to show all
    const [questions, setQuestions] = useState([
        { id: 1, name: 'Dinesh', difficulty: 'Easy', solveLink: 'https://practice.geeksforgeeks.org/problems/selection-sort/1', checked: false },
        { id: 2, name: 'Problem 2', difficulty: 'Medium', solveLink: 'https://www.hackerearth.com/practice/algorithms/sorting/selection-sort/practice-problems/algorithm/old-keypad-in-a-foreign-land-24/', checked: false },
        { id: 3, name: 'Problem 2', difficulty: 'Easy', solveLink: 'https://www.codingninjas.com/studio/problems/selection-sort_981162', checked: false },
    ...
    return (
        <div className='bg-color pb-10'>
            ...
            <div className='flex flex-col justify-center items-center'>
                <h1 className="card-heading text-[3rem] mb-4">Selection Sort Problems</h1>
