...
export default function QueueProblems() {
    ...
    return (
        <div className='bg-color pb-10'>
            <div className='max-w-[1200px] m-auto'>
                <VisualizeHeader routePath='/dataStructure/queue/queue-problems' />
            </div>
            <div className='flex flex-col justify-center items-center'>
                <h1 className="card-heading text-[3rem] mb-4 pt-10">Queue Problems</h1>
