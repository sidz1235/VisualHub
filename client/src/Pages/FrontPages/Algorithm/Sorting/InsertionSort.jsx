...
import VisualizeInsertion from "../../../Visualizations/VisualizeInsertion";
...
export default function InsertionSort() {
    ...
    useEffect(()=>{
      ...
      if (algorithmName && algorithmName.toLowerCase() === 'merge sort') {
  ...
  return (
    <div className="bg-color h-screen">
      <div className='max-w-[1200px] m-auto h-full'>
        <VisualizeHeader
          routePath="/algorithms/sort/insertion-sort"
