...
import VisualizeHeap from "../../../Visualizations/VisualizeHeap";
import Description from "../../../../Components/Description";

export default function HeapSort() { 
    
    const [array, setArray] = useState("7 4 3 6 1 2");
    ...
    const handleDropdownChange = (event) => {
        ...
        switch(selectedOption){
          case "Integer" : 
                        setArray('7 4 3 6 1 2');
                        break;
          case "Float" : 
                        setArray("7.0 4.0 3.0 6.0 1.0 2.0");
                        break;
          case "Character": 
                        setArray("e b a d c");
                        break;
          default: 
                  setArray("ef gh df sy ti re lm nt");
        }
  ...
  return (
    <div className="bg-color h-screen">
      <div className='max-w-[1200px] m-auto h-full'>
        <VisualizeHeader
          routePath="/algorithms/sort/heap-sort"
