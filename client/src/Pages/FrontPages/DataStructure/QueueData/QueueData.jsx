...
import VisualizeQueue from "../../../Visualizations/VisualizeQueue";
...
const QueueData = () => {
  ...
  const [type,setType] = useState('enqueue');
  const [startVis,setStartVis] = useState(false);
  const [intialLength,setInitialLength] = useState();
  ...
  const visualizeBinarySearch = () => {
    ...
    setInitialLength(arrayValues.length);
    let newArray = new Array(9);
    for(let i = 0 ; i < arrayValues.length ; i++){
      newArray[i] = arrayValues[i];
    }
          ...
          <div className="flex justify-around items-center h-[80%]">
            <div className="border bg-input p-4 flex h-[80%] flex-col justify-between">
                ...
                </div>
                {
                  ...
                  ?
                    <div>
                        <label for='input-element'>Element:</label>
                        <input 
                            name="input-element"
                            type="text"
                            id="input-element"
